    ...
    try {
      ...
      if (status.message) {
        ...
        if (status.message.includes('Starting video download')) {
          ...
          status.message.includes('Analyzing video content') ||
          status.message.includes('Sending prompt to Gemini')
        ) {
          setProcessingStage('generating');
        } else if (
          status.message.includes('Processing clip') ||
          status.message.includes('Creating highlights')
        ) {
